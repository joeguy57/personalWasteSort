...
//  }
  ...
  public boolean onTouch(View v, MotionEvent event) {
    DragShadowBuilder shadowBuilder = new View.DragShadowBuilder(v);
    v.startDrag(null, shadowBuilder, v, 0);
    v.setVisibility(View.VISIBLE); //the error seems to be on this line...
    // depending on whats v we may not be returning the constraint back to Visible
    return true;
  }//onTouch
}//gameActivity